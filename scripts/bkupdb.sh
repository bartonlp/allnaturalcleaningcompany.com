...
mysqldump --user=root --no-data --password=bartonl411 allnatural > $dir/allnatural.schema
mysqldump --user=root --add-drop-table --password=bartonl411 allnatural >$dir/$filename
